...
class AIPlayer: public Player{
    ...
    //void MiHeuristica(color & c_piece, int & id_piece, int & dice) const;
    ...
    double Min_Max(const Parchis &actual, int jugador, int profundidad, int profundidad_max, color &c_piece, int &id_piece, int &dice, double (*heuristic)(const Parchis &, int)) const;//lo de heuristic
